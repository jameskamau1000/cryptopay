...
class AdminController extends Controller
{
    ...
    {
        return to_route('admin.dashboard')->withErrors('Remote reporting is disabled for this installation.');
    }

    public function reportSubmit(Request $request)
    {
        return back()->withErrors('Remote reporting is disabled for this installation.');
    }
