...
class SiteController extends Controller
{
    ...
    public function developerDocumentation(){
        $pageTitle = 'Developer Documentation';
        $baseUrl = rtrim(config('app.url'), '/');
        $allCurrency = GatewayCurrency::whereHas('method', function ($gate) {
                            $gate->where('status', Status::ENABLE);
                        })->get(['id','currency','symbol'])->unique('currency');
        return view('Template::developers.documentation', compact('pageTitle', 'allCurrency', 'baseUrl'));
    }

    public function apiReference(){
        $pageTitle = 'API Reference';
        $baseUrl = rtrim(config('app.url'), '/');
        return view('Template::developers.reference', compact('pageTitle', 'baseUrl'));
    }
}
