...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withMiddleware(function (Middleware $middleware) {
        ...
        $middleware->alias([
            ...
            'api.idempotency' => \App\Http\Middleware\ApiIdempotencyMiddleware::class,
            'api.request.log' => \App\Http\Middleware\ApiRequestLoggerMiddleware::class,
            'api.scope' => \App\Http\Middleware\ApiScopeMiddleware::class,
            'admin.ip.allowlist' => \App\Http\Middleware\AdminIpAllowlistMiddleware::class,
            'payouts.enabled' => \App\Http\Middleware\PayoutsEnabledMiddleware::class,
        ]);
