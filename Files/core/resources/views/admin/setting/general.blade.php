                    ...
                    <form method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-xl-3 col-sm-6 ">
                                ...
                                <input type="text" class="form-control" name="api_prefix" value="{{ gs('api_prefix') }}"/>
                            </div>
                            <div class="form-group col-xl-3 col-sm-6 ">
                                <label> @lang('Api Test prefix')</label>
                                <input type="text" class="form-control" name="api_test_prefix" value="{{ gs('api_test_prefix') }}"/>
                            </div>
                            <div class="form-group col-xl-3 col-sm-6 ">
                                <label for="payment_fixed_charge">@lang('Payment Fixed Charge')</label>
                                <div class="input-group">
                                    <input type="number" step="any" name="payment_fixed_charge" class="form-control" required value="{{ getAmount(gs('payment_fixed_charge')) }}">
                            ...
                            <div class="form-group col-xl-3 col-sm-6 ">
                                ...
                                <div class="input-group">
                                    <input type="number" step="any" name="payment_percent_charge" class="form-control" required value="{{ getAmount(gs('payment_percent_charge')) }}">
