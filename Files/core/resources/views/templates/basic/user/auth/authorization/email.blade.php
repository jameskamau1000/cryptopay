            ...
            <div class="verification-code-wrapper">
                <div class="verification-area">
                    ...
                    <form action="{{route('user.verify.email')}}" method="POST" class="submit-form">
                        ...
                        <div class="mb-3">  
                            <p>
                                @lang('Don\'t get any code'), <span class="countdown-wrapper">@lang('try again after') <span id="countdown" class="fw-bold">--</span> @lang('seconds')</span> <a href="{{route('user.send.verify.code', 'email')}}" class="try-again-link d-none anchor-color"> @lang('Try again')</a>
                            </p>
