                ...
                <div class="verification-area">
                    ...
                    <form action="{{route('user.verify.mobile')}}" method="POST" class="submit-form">
                        ...
                        <div class="form-group">
                            <p>
                                @lang('Don\'t get any code'), <span class="countdown-wrapper">@lang('try again after') <span id="countdown" class="fw-bold">--</span> @lang('seconds')</span> <a href="{{route('user.send.verify.code', 'sms')}}" class="try-again-link d-none anchor-color"> @lang('Try again')</a>
                            </p>
